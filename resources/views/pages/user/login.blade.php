...
<html lang="en">
	<!--begin::Head-->
	<head><base href="../../../">
		<title>Breakdown Sys - Login</title>
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(/assets/default/9.png)">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					<!--begin::Logo-->
					<h1 class="mb-10 text-primary display-3">Breakdown Sys</h1>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" action="{{ route('masuk') }}" method="POST">
							...
							@if(session()->has('ganti password'))
							 <!--begin::Alert-->
								<div class="alert alert-dismissible bg-info d-flex flex-column flex-sm-row p-5 mb-10">
									<!--begin::Icon-->
									<span class="svg-icon svg-icon-4hx svg-icon-gray-100 me-4 mb-5 mb-sm-0">
									...
									<div class="d-flex flex-column text-light pe-0 pe-sm-10">
										<!--begin::Title-->
										<h4 class="mb-2 text-light">Password sudah diganti!</h4>
										<!--end::Title-->

										<!--begin::Content-->
										<span>Silahkan Login menggunakan password yang baru</span>
										<!--end::Content-->
									</div>
									<!--end::Wrapper-->
