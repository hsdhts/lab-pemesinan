...
<form action="/kernel-hydrocylone/update/" method="post" enctype="multipart/form-data">
    @method('put')
    @csrf
    ...
    <div class="mb-3">
        <label for="image_kernelHydroCylone" class="form-label">Gambar Sample</label>
        <input type="file" class="form-control @error('image_kernelHydroCylone') is-invalid @enderror" id="image_kernelHydroCylone" name="image_kernelHydroCylone">
        @error('mesin_image')
        <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
