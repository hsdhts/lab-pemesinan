...
<script>
    $('#tabelTemplate').DataTable({
        ...
        serverSide: true,
        ajax: "/hydrocyclone-losses",
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false},
            {data: 'image_HydroCycloneLosses', name: 'image_HydroCycloneLosses',
                render: function(data, type, full, meta) {
                    return '<img src="{{ asset('storage') }}/'+data+'" alt="Sample Hydrocyclone" style="max-width: 100px; max-height: 100px; cursor: pointer;" onclick="setModalImage(\''+data+'\', \'gambarSampleKernelModal\')">'
                }
            },
