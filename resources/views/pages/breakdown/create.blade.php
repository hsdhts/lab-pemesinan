...
<form action="/breakdown/create" method="post">
...
<div class="mb-4">
    <label for="pic" class="form-label">Pilih Stasiun</label>
     <select class="form-select @error('kategori_id') is-invalid @enderror" id="kategori_id" aria-label="Pilihan untuk Stasiun" value="{{ old('kategori_id') }}" name="stasiun_id">
