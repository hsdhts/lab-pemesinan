...
<div class="mb-3">
    ...
    <input type="text" class="form-control @error('inspection_item') is-invalid @enderror" id="inspection_item" placeholder="Inspection Item " value="{{ old('inspection_item') }}" name="inspection_item">
...
<div class="input-group mb-5">
    ...
    <ul class="dropdown-menu"> 
      ...
      <li><a class="dropdown-item" onclick="setSatuan('Good')">Good</a></li>
