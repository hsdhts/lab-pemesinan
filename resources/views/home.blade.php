...
@include('partials.modalReminder')
    ...
    <div class="row g-5 g-xl-8">
        <div class="col-xl-3">
            ...
            <a class="card bg-danger hoverable card-xl-stretch mb-xl-8" data-bs-toggle="modal" data-bs-target="#kt_modal_2">
                <!--begin::Body-->
                <div class="card-body">
                    @if($kernel_hydrocyclones->count() > 0 and $kernel_hydrocyclones->count() < 100)
                    <span class="position-absolute top-0 fs-3 start-100 p-7 translate-middle badge badge-circle badge-warning">{{ $kernel_hydrocyclones->count() }}</span>
                    @elseif($kernel_hydrocyclones->count() > 100)
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">KERNEL HYDROCYCLONE</div>
                    <div class="fw-bold text-gray-200">Total Data Kernel Hydrocyclone</div>
                </div>
                <!--end::Body-->
            </a>
        ...
        <div class="col-xl-3">
            <!--begin::Statistics Widget 5-->
            <a class="card bg-dark hoverable card-xl-stretch mb-xl-8" data-bs-toggle="modal" data-bs-target="#kt_modal_3">
                <!--begin::Body-->
                <div class="card-body">
                    @if($hydrocyclone_losses->count() > 0 and $hydrocyclone_losses->count() < 100)
                    <span class="position-absolute top-0 fs-3 start-100 p-7 translate-middle badge badge-circle badge-warning">{{ $hydrocyclone_losses->count() }}</span>
                    @elseif($hydrocyclone_losses->count() > 100)
                    <span class="position-absolute top-0 fs-3 start-100 p-7 translate-middle badge badge-circle badge-warning">99+</span>
                    @endif
                    <!--begin::Svg Icon-->
                    <span class="svg-icon svg-icon-light svg-icon-3x ms-n1">
                    ...
                    <!--end::Svg Icon-->
                    <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">HYDROCYCLONE LOSSES</div>
                    <div class="fw-bold text-gray-100">Total Data Hydrocyclone Losses</div>
                </div>
                <!--end::Body-->
            </a>
            <!--end::Statistics Widget 5-->
